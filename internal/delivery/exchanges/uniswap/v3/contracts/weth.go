...
func (_Main *MainTransactor) Approve(opts *bind.TransactOpts, guy common.Address, wad *big.Int) (*types.Transaction, error) {
	return _Main.contract.Transact(opts, "approve", guy, wad)
}

// Approve is a paid mutator transaction binding the contract method 0x095ea7b3.
//
// Solidity: function approve(address guy, uint256 wad) returns(bool)
func (_Main *MainSession) Approve(guy common.Address, wad *big.Int) (*types.Transaction, error) {
	return _Main.Contract.Approve(&_Main.TransactOpts, guy, wad)
}

// Approve is a paid mutator transaction binding the contract method 0x095ea7b3.
//
// Solidity: function approve(address guy, uint256 wad) returns(bool)
func (_Main *MainTransactorSession) Approve(guy common.Address, wad *big.Int) (*types.Transaction, error) {
	return _Main.Contract.Approve(&_Main.TransactOpts, guy, wad)
}
...
func (_Main *MainTransactor) Deposit(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Main.contract.Transact(opts, "deposit")
}

// Deposit is a paid mutator transaction binding the contract method 0xd0e30db0.
//
// Solidity: function deposit() payable returns()
func (_Main *MainSession) Deposit() (*types.Transaction, error) {
	return _Main.Contract.Deposit(&_Main.TransactOpts)
}

// Deposit is a paid mutator transaction binding the contract method 0xd0e30db0.
//
// Solidity: function deposit() payable returns()
func (_Main *MainTransactorSession) Deposit() (*types.Transaction, error) {
	return _Main.Contract.Deposit(&_Main.TransactOpts)
}
...
func (_Main *MainTransactor) Withdraw(opts *bind.TransactOpts, wad *big.Int) (*types.Transaction, error) {
	return _Main.contract.Transact(opts, "withdraw", wad)
}

// Withdraw is a paid mutator transaction binding the contract method 0x2e1a7d4d.
//
// Solidity: function withdraw(uint256 wad) returns()
func (_Main *MainSession) Withdraw(wad *big.Int) (*types.Transaction, error) {
	return _Main.Contract.Withdraw(&_Main.TransactOpts, wad)
}

// Withdraw is a paid mutator transaction binding the contract method 0x2e1a7d4d.
//
// Solidity: function withdraw(uint256 wad) returns()
func (_Main *MainTransactorSession) Withdraw(wad *big.Int) (*types.Transaction, error) {
	return _Main.Contract.Withdraw(&_Main.TransactOpts, wad)
}
...
func (_Main *MainFilterer) FilterApproval(opts *bind.FilterOpts, src []common.Address, guy []common.Address) (*MainApprovalIterator, error) {
	...
	logs, sub, err := _Main.contract.FilterLogs(opts, "Approval", srcRule, guyRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event Approval(address indexed src, address indexed guy, uint256 wad)
func (_Main *MainFilterer) WatchApproval(opts *bind.WatchOpts, sink chan<- *MainApproval, src []common.Address, guy []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Main.contract.WatchLogs(opts, "Approval", srcRule, guyRule)
	if err != nil {
		return nil, err
	}
...
func (_Main *MainFilterer) FilterDeposit(opts *bind.FilterOpts, dst []common.Address) (*MainDepositIterator, error) {
	...
	logs, sub, err := _Main.contract.FilterLogs(opts, "Deposit", dstRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event Deposit(address indexed dst, uint256 wad)
func (_Main *MainFilterer) WatchDeposit(opts *bind.WatchOpts, sink chan<- *MainDeposit, dst []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Main.contract.WatchLogs(opts, "Deposit", dstRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
...
// MainWithdrawalIterator is returned from FilterWithdrawal and is used to iterate over the raw logs and unpacked data for Withdrawal events raised by the Main contract.
type MainWithdrawalIterator struct {
	Event *MainWithdrawal // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *MainWithdrawalIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *MainWithdrawalIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *MainWithdrawalIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// MainWithdrawal represents a Withdrawal event raised by the Main contract.
type MainWithdrawal struct {
	Src common.Address
	Wad *big.Int
	Raw types.Log // Blockchain specific contextual infos
}
...
func (_Main *MainFilterer) FilterWithdrawal(opts *bind.FilterOpts, src []common.Address) (*MainWithdrawalIterator, error) {
	...
	logs, sub, err := _Main.contract.FilterLogs(opts, "Withdrawal", srcRule)
	if err != nil {
		return nil, err
	}
	return &MainWithdrawalIterator{contract: _Main.contract, event: "Withdrawal", logs: logs, sub: sub}, nil
}

// WatchWithdrawal is a free log subscription operation binding the contract event 0x7fcf532c15f0a6db0bd6d0e038bea71d30d808c7d98cb3bf7268a95bf5081b65.
//
// Solidity: event Withdrawal(address indexed src, uint256 wad)
func (_Main *MainFilterer) WatchWithdrawal(opts *bind.WatchOpts, sink chan<- *MainWithdrawal, src []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Main.contract.WatchLogs(opts, "Withdrawal", srcRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(MainWithdrawal)
				if err := _Main.contract.UnpackLog(event, "Withdrawal", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event Withdrawal(address indexed src, uint256 wad)
func (_Main *MainFilterer) ParseWithdrawal(log types.Log) (*MainWithdrawal, error) {
	event := new(MainWithdrawal)
	if err := _Main.contract.UnpackLog(event, "Withdrawal", log); err != nil {
		return nil, err
	}
