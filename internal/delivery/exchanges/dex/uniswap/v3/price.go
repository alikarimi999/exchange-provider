...
type Price struct {
	*Fraction
	BaseCurrency  types.Token // input i.e. denominator
	QuoteCurrency types.Token // output i.e. numerator
...
func NewPrice(baseCurrency, quoteCurrency types.Token, denominator, numerator *big.Int) *Price {
	return &Price{
